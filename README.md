...
10. Write a program to accept N numbers in an array, and then sort the array using Quick Sort.


11. Write a program to accept N numbers from the user in one array and M numbers in another array. Then, sort the arrays using Selection Sort and then merge these two arrays using Merge Sort.


12. Write a menu driven program that implements the following operations on a   
Binary search tree :
